...
Пройтись по файлу с ipv4 адресами и проверить, что в каждой строке содержится корректный ip адрес. Если есть некорректный, то распечатать его. Конечная цель проверить количество найденных адресов и количество строк в файле
"""
def ip4():
    ip4 = re.compile(r"""
                    (?:(?:25[0-5]           # 250-255
